...
public class Programme3_MarkSheet {
    ...
    public static String calculateGrade(int percenatge, String result){
        String grade = null;
    ...
    public static void printTheMarkSheet(String name, int rollNum, int mathsMarks, int scienceMarks, int englishMarks, double total, double percenatge, String result, String grade){
